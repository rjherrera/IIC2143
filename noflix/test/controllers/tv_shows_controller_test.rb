...
class TvShowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tv_show" do
    assert_difference('TvShow.count') do
      post tv_shows_url, params: { tv_show: { category: @tv_show.category, country: @tv_show.country, end_year: @tv_show.end_year, language: @tv_show.language, plot: @tv_show.plot, start_year: @tv_show.start_year, title: @tv_show.title } }
    end
  ...
  test "should update tv_show" do
    patch tv_show_url(@tv_show), params: { tv_show: { category: @tv_show.category, country: @tv_show.country, end_year: @tv_show.end_year, language: @tv_show.language, plot: @tv_show.plot, start_year: @tv_show.start_year, title: @tv_show.title } }
